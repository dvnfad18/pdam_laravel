...
<form action="/pdam/kategoriupdatedata/{{$data->idKategori}}" method='POST' enctype="multipart/form-data">
    ...
    <div class="my-3 p-3 bg-body rounded shadow-sm">
        <div class="mb-3 row">
            ...
            <div class="col-sm-10">
                <input type="text" class="form-control" name='idKategori' id="nama" value="{{$data->idKategori}}">
            </div>
        </div>
        <div class="mb-3 row">
            <label for="jurusan" class="col-sm-2 col-form-label">Kategori</label>
            <div class="col-sm-10">
                <input type="text" class="form-control" name='kategori' id="jurusan" value="{{$data->kategori}}">
            </div>
        </div>
        <div class="mb-3 row">
